...
def init_db():
    ...
    session.execute("INSERT INTO playlist_tracks (playlist_id, trackurl) VALUES (1,['http://localhost:8000/tracks/1','http://localhost:8000/tracks/2','http://localhost:8000/tracks/3','http://localhost:8000/tracks/4'])")
    session.execute("INSERT INTO playlist_tracks (playlist_id, trackurl) VALUES (2,['http://localhost:8000/tracks/1','http://localhost:8000/tracks/2','http://localhost:8000/tracks/3','http://localhost:8000/tracks/4'])")
    session.execute("INSERT INTO playlist_tracks (playlist_id, trackurl) VALUES (3,['http://localhost:8000/tracks/1','http://localhost:8000/tracks/2','http://localhost:8000/tracks/3','http://localhost:8000/tracks/4'])")
    session.execute("INSERT INTO playlist_tracks (playlist_id, trackurl) VALUES (4,['http://localhost:8000/tracks/1','http://localhost:8000/tracks/2','http://localhost:8000/tracks/3','http://localhost:8000/tracks/4'])")
    session.execute("INSERT INTO playlist_tracks (playlist_id, trackurl) VALUES (5,['http://localhost:8000/tracks/1','http://localhost:8000/tracks/2','http://localhost:8000/tracks/3','http://localhost:8000/tracks/4'])")
