...
def create_playlist():
    ...
    command = "INSERT INTO playlist_tracks (playlist_id, trackurl) VALUES ( getNewId ,['http://localhost:8000/tracks/1','http://localhost:8000/tracks/2','http://localhost:8000/tracks/3','http://localhost:8000/tracks/4'])"
